...
public class AgendaTelefonica {
    ...
    public AgendaTelefonica (string nombres, string correo, string direccion, int telefono) {
        ...
        public string getdireccion() {return cifrado. descifrarcesar (direccion, desp: 3); }
        public int gettelefono() {return cifrado. descifrarcesar (telefono, desp: 3): }

        public void setnombre(string nombre) {this,nombre = cifrado.cifradocesar (nombre, desp: 3); } 
